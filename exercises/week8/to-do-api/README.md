#Store
  ...
  #Reducers
  -change the state of each action item
  ...
  -add down the handle change function and submit action via props

  # add component
  -rendering actual html in the form of theinputs and buttons with their respective event handlers (onChange and onSubmit)


# to do list container
- link the array of todos via props (get action) from store
-render the to do -list component
-pass down the list via props to to do list component
