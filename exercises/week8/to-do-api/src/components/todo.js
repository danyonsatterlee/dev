        ...
        return (
            <div>
                ...
                this.props.handleChange("description",event);
                    ...
                    <button onClick={() =>{this.props.handleEdit(this.props.item._id, this.props.info)}} className="btn-warning btn-custom">edit</button>
                    <button onClick= {()=>{ this.props.handleRemove(this.props.item._id);}} className="btn-success btn-custom">complete</button>
                </li>
            </div>
        );
    }
